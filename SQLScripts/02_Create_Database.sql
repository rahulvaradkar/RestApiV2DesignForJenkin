/****************************************
--Replace 'BAE_4_3' with the desired name
****************************************/
USE [master]
GO

CREATE DATABASE [BAE_4_3]
ON  PRIMARY 
( 
	NAME		= N'BAE_4_3', 
	FILENAME	= N'C:\BAE_4_3.mdf' , 
	SIZE		= 8192KB , 
	MAXSIZE		= UNLIMITED, 
	FILEGROWTH	= 1024MB )
LOG ON 
...
BEGIN
	EXEC	[BAE_4_3].[DBO].[SP_FULLTEXT_DATABASE] 
			@ACTION = 'ENABLE'
END
GO

ALTER	DATABASE [BAE_4_3] 
