...
public class MyTables  extends BWServlet implements SingleThreadModel
{
    ServletContext sc;
    ...
    public void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
		...
		if (tableCreateAction != null && tableCreateAction.equals("getBlob"))
		{}// Do nothing
		else{
	...
	public static  String getValuesOfLookUpTable(int tableIdVal, int lookupColId)throws ServletException, IOException
	{
		...
		try
		{
			...
			String lsSql = " SELECT STRING_VALUE FROM BW_CELL, BW_TBL, BW_ROW, BW_COLUMN "+
						   ...
						   " AND BW_CELL.BW_COLUMN_ID = BW_COLUMN.ID AND BW_ROW.BW_TBL_ID = BW_TBL.ID AND BW_COLUMN.ID = ?"+
...
//						   System.out.println(" sql for "+lsSql);
			...
			preparedstatement.setInt(1,tableIdVal);
			preparedstatement.setInt(2,lookupColId);
