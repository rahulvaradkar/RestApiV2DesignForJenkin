...
FROM    BW_ROW   BWROW, 
	BW_COLUMN   BWCOLUMN,
	BW_TBL   BWTABLE RIGHT OUTER JOIN BW_CELL   BWCELL
	ON BWTABLE.ID = BWCELL.TABLE_VALUE, 
	BW_USER, 
	BW_MEMBER,BW_TXS   BW_USER_TX,
...
WHERE	
	...
	AND     BWROW.OWNER_ID =  BW_USER.ID
	AND     BW_USER.ID = BW_MEMBER.USER_ID
	AND 	BW_MEMBER.NEIGHBORHOOD_ID = ?
