SELECT 	BWROW.NAME ROW_NAME, 
	...
	BWCELL.DESIGN_STRING_VALUE CELL_STRING_VALUE, 
	BWCELL.DESIGN_INTEGER_VALUE CELL_INTEGER_VALUE, 
	BWCELL.DESIGN_DOUBLE_VALUE CELL_DOUBLE_VALUE, 
	BWCELL.DESIGN_TBL_VALUE CELL_TBL_VALUE, 
...
FROM    	
	BW_ROW BWROW, 
	BW_COLUMN BWCOLUMN, 
	BW_TBL BWTABLE RIGHT OUTER JOIN BWCELL ON BWTABLE.ID = BWCELL.DESIGN_TBL_VALUE, 
	BW_TXS, 
	BW_USER,
...
WHERE	
	...
	AND     BWCELL.DESIGN_TX_ID = BW_TXS.TX_ID
...
ORDER BY  BWROW.ID, BWCOLUMN.SEQUENCE_NUMBER