...
import servlets.xlGetRowUpdates;

public class xlGetRowUpdatesServletTest {
	@Mock
    ...
    public void test() throws Exception {
	 	...
	 	String buffer=ds.getTableID()+"Week152461440000015252192000005129,1199,1200,-11525270410000"+ds.getUserId()+Seperator+ds.getMemberID()+Seperator;
...
//		encode to Base64 string
		...
		new xlGetRowUpdates().service(request, response);
