...
public class DataSet {
	...
	public static String propFileLocation2 = "C:\\JUnit\\testdata3.properties";
	...
	public DataSet() throws IOException
	  {
	   ...
	   {		   		   
		   ...
		   try
		   {
			   	...
			   	InputStream is3 = new FileInputStream("D:\\Heat\\BAE_4_3\\Export.properties");
				serverproperties3.load(is3);				
				tno=serverproperties3.getProperty("tno");
				
				serverproperties2 = new Properties();
				InputStream is2 = new FileInputStream("D:\\Heat\\BAE_4_3\\testdata.properties");
