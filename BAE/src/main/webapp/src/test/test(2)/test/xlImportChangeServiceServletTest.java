...
public class xlImportChangeServiceServletTest 
{
	...
	public static String propFileLocation="D:\\Heat\\BAE_4_3\\testdata.properties";
    ...
    public void test() throws Exception {
		...
		String buffer=ds.getUserId()+Seperator+ds.getUsername()+Seperator+ds.getMemberID()+Seperator+ds.getNHID()+Seperator+ds.getTableID()+Seperator+"-1"+Seperator+"LATEST"+Seperator+ds.getImportId()+Seperator+ds.getExportId()+"0051285129";
...
//		encode to Base64 string
		...
		new xlImportChangesService().service(request, response);
