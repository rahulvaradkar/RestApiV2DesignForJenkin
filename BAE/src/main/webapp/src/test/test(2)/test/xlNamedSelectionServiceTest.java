...
import servlets.xlNamedSelectionService;

public class xlNamedSelectionServiceTest {
	@Mock
    ...
    public void test() throws Exception {
	 	...
	 	String buffer="Get"+Seperator+ds.getUserId()+Seperator+"5129"+Seperator+"1200"+Seperator+ds.getImportId()+Seperator+ContentDelimeter;
...
//		encode to Base64 string
		...
		new xlNamedSelectionService().service(request, response);
