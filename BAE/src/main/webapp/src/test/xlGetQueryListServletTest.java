...
import servlets.xlGetQueryList;

public class xlGetQueryListServletTest {
	@Mock
    ...
    public void test() throws Exception {
	 	...
	 	String buffer=ds.getUserId()+Seperator+ds.getUsername()+Seperator+ds.getMemberID()+Seperator+ds.getNHID()+Seperator+ds.getTableID()+Seperator+ds.getBaselineId()+Seperator+ds.getView()+Seperator+ds.getImportId()+Seperator+ds.getExportId();
...
//		encode to Base64 string
		...
		new xlGetQueryList().service(request, response);
