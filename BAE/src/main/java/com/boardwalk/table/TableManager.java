...
public class TableManager{
	    ...
	    throws SQLException
	{
		...
		try
		{
			...
			String rowQuery = TableViewManager.getRowQuery(a_connection, tableId, userId, criteriaTableId, false, viewPref, "TABLE"); //Modified by Lakshman on 20171108 to avoid self joins on BW_CELL for performance gain
			String lsSql	= "";
			Calendar cal	= Calendar.getInstance(TimeZone.getTimeZone("GMT"));
