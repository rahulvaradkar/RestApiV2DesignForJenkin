...
//			connection3 = databaseloader.getConnection();
			...
			stmt = connection3.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
...
////////////////////////////////////////////////////
	...
	throws SystemException
    {
		...
		try {
			...
			if ( DatabaseLoader.getDatabaseType().trim().equalsIgnoreCase("ORACLE")) //sjcd comm
			{
				System.out.println("Inside ORACLE getMembershipsForUser() : userId = " + userId);
				preparedStatement = DatabaseLoader.getPreparedStatementFromPreLoadedQueries("BW_GET_MEMBERSHIPS_FOR_USER", connection );
            	preparedStatement.setInt(1,userId);
