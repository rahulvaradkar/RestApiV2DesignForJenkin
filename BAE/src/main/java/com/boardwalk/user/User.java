...
public class User {
   int     m_id;
   String  m_address;
   String  m_extuserid; // shirish 4/8/2015
   String m_password;
   String m_firstName;
   String m_lastName;
...
//added isActive by Rahul Varadkar on 08-August-2015
  public User (int a_id, String a_address, String a_extUserId, String a_firstName, String a_lastName, int isActive) {
    m_id = a_id;
    m_address = a_address;
	m_extuserid = a_extUserId;
    m_password="No Permission to see password";
    m_firstName = a_firstName;
    m_lastName = a_lastName;
	m_Active = isActive;
  	...
  	// constructor to return extuserid and email address both - shirish 8/4/2015
  public User (int a_id, String a_address, String a_extUserId, String a_firstName, String a_lastName) {
	    m_id = a_id;
	    m_address = a_address;
	    m_extuserid = a_extUserId;
	    m_password="No Permission to see password";
  ...
  //to return extuserid  - shirish 8/4/2015
