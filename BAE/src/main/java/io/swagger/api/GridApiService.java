...
public abstract class GridApiService {
    ...
    public abstract Response gridGridIdTransactionsBetweenTidsGet(Integer gridId,  @NotNull Long localTimeAfter111970, @NotNull Integer startTid, @NotNull Integer endTid, @NotNull String viewPref, SecurityContext securityContext, String authBase64String) throws NotFoundException;
    public abstract Response gridGridIdTransactionsGet(Integer gridId, @NotNull Long localTimeAfter111970, @NotNull String viewPref, @NotNull String reportType, String activityPeriod, Long startDate, Long endDate, Integer importTid,SecurityContext securityContext, String authBase64String) throws NotFoundException;
    public abstract Response gridGridIdTxIdTransactionIdChangesGet(Integer gridId,Integer transactionId, @NotNull Long localTimeAfter111970, @NotNull String viewPref, SecurityContext securityContext, String authBase64String) throws NotFoundException;
