...
public class GridChanges   {
  ...
  public GridChanges rows(List<Row> rows) {
    this.rows = rows;
    return this;
  }

  public GridChanges addRowsItem(Row rowsItem) {
    if (this.rows == null) {
  ...
  public GridChanges columns(List<Column> columns) {
    this.columns = columns;
    return this;
  }

  public GridChanges addColumnsItem(Column columnsItem) {
  ...
  public GridChanges cells(List<Cell> cells) {
    this.cells = cells;
    return this;
  }

  public GridChanges addCellsItem(Cell cellsItem) {
    if (this.cells == null) {
