		...
		throws SystemException
	{
		...
		try
		{
			...
			while (ai.hasNext())
			{
				...
				String srcRowQuery = TableViewManager.getRowQuery(connection, sourceTableId, 1, sourceFilterId, true, "LATEST", "RESULTSET"); //Modified by Lakshman on 20171108 to avoid self joins on BW_CELL for performance gain
				...
				String targetRowQuery = TableViewManager.getRowQuery(connection, targetTableId, 1, targetFilterId, true, "LATEST", "RESULTSET"); //Modified by Lakshman on 20171108 to avoid self joins on BW_CELL for performance gain
				...
				String distrRowQuery = TableViewManager.getRowQuery(connection, distributionTableId, 1, distributionFilterId, true, "LATEST", "RESULTSET"); //Modified by Lakshman on 20171108 to avoid self joins on BW_CELL for performance gain
