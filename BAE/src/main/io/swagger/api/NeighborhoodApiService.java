...
public abstract class NeighborhoodApiService {
    ...
    public abstract Response neighborhoodNhIdRelationDelete(Integer nhId, @NotNull Integer relation,SecurityContext securityContext, String authBase64String) throws NotFoundException;
