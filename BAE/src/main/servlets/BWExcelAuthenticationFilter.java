...
extends ExcelAuthenticationFilter
{
			...
			ServletRequest request, ServletResponse response, FilterChain chain)
	{
		...
		else if(rURI.contains("/rest/v1/") || rURI.contains("xlLogoutService") || rURI.contains("forgotPassword") || rURI.endsWith("jsp") || rURI.contains("logo-boardwalk.gif"))// to bypass filter for jsp in weblogic deployment
		{
			try {
