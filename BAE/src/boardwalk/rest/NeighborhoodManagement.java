...
public class NeighborhoodManagement {
	...
	public static int neighborhoodNhIdMemberMemberIdCollaborationPost(int nhId, int memberId, Collaboration collaboration, ArrayList <ErrorRequestObject> ErrResps)
	{
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			...
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdMemberMemberIdCollaborationPost::getBoradwalkConnection");
		...
		catch (SQLException sqe)
		{
			...
			erb.setPath("NeighborhoodManagement.neighborhoodNhIdMemberMemberIdCollaborationPost::getConnection");
    ...
    //@GET
    //@Path("/{nhId}/relation")
	public static ArrayList <Relation> 	neighborhoodNhIdRelationGet(int nhId, ArrayList <ErrorRequestObject> ErrResps)
	{
		ErrorRequestObject erb;
		ArrayList <Relation> rels = new ArrayList<Relation>();
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdRelationGet::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return rels;
		...
		catch (SQLException sqe)
		{
			erb = new ErrorRequestObject();
			erb.setError("SQLException:" + sqe.getCause());
			erb.setPath("NeighborhoodManagement.neighborhoodNhIdRelationGet::getConnection");
			erb.setProposedSolution("Get DBConnection failed. Contact Boardwalk System Administrator");
			ErrResps.add(erb);
			sqe.printStackTrace();
		}
    ...
    //@POST
    //@Path("/{nhId}/relation")
    public static String neighborhoodNhIdRelationPost(int nhId, Relation relationship, ArrayList <ErrorRequestObject> ErrResps)
    {
    	String strRet = null;
        ErrorRequestObject erb;
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdRelationPost::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return strRet;
    		...
    		try
    		{
	            ...
	            {	//Some Relations are successfully created
	            	erb = new ErrorRequestObject(); erb.setError("Failure"); erb.setPath("relationship.nhList[].Id"); 
 					erb.setProposedSolution("Check Detail Report of Relations created for all Neighborhood Ids.");
 					ErrResps.add(erb );
...
//	        }	 		    			
		...
		catch (SQLException sqe)
		{
			erb = new ErrorRequestObject();
			erb.setError("SQLException:" + sqe.getCause());
			erb.setPath("neighborhoodNhIdMemberGet.neighborhoodNhIdRelationPost::getConnection");
			erb.setProposedSolution("Get DBConnection failed. Contact Boardwalk System Administrator");
			ErrResps.add(erb);
			sqe.printStackTrace();
		}
	...
	public static String neighborhoodNhIdMemberMemberIdDelete(int nhId, int memberId, ArrayList <ErrorRequestObject> ErrResps)
	{
		String strRet = null;
        ErrorRequestObject erb;
        // get the connection
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdMemberMemberIdDelete::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return strRet;
		...
		catch (SQLException sqe)
		{
			erb = new ErrorRequestObject();
			erb.setError("SQLException:" + sqe.getCause());
			erb.setPath("neighborhoodNhIdMemberGet.neighborhoodNhIdMemberMemberIdDelete::getConnection");
			erb.setProposedSolution("Get DBConnection failed. Contact Boardwalk System Administrator");
			ErrResps.add(erb);
			sqe.printStackTrace();
		}
    ...
    //@POST
    //@Path("/{nhId}/member")
	public static ArrayList<Member> neighborhoodNhIdMemberPost(int nhId, Member member, ArrayList <ErrorRequestObject> ErrResps)
	{
		 ArrayList <Member> memberList = new ArrayList<Member>();
	    	...
	    	try
	    	{
	    		...
	    		catch(BoardwalkException bwe)
	    		{
	    			erb = new ErrorRequestObject();
	    			erb.setError("Authentication_Connection_Failure");
	    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdMemberPost::getBoradwalkConnection");
	    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
	    			ErrResps.add(erb);
	    		    System.out.println("Authentication/Connection Failed");
	    		    return memberList;
			...
			catch (SQLException sqe)
			{
				erb = new ErrorRequestObject();
				erb.setError("SQLException:" + sqe.getCause());
				erb.setPath("neighborhoodNhIdMemberGet.neighborhoodNhIdMemberGet::getConnection");
				erb.setProposedSolution("Get DBConnection failed. Contact Boardwalk System Administrator");
				ErrResps.add(erb);
				sqe.printStackTrace();
			}
	...
	//@DELETE
    //@Path("/{nhId}")
	public static String neighborhoodNhIdDelete(int nhId, ArrayList <ErrorRequestObject> ErrResps)
	{
		String retMsg = null;
        ErrorRequestObject erb;
        // get the connection
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdDelete::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return "Failed to Delete Neighborhood";
    		}
    		//Custom Code Starts
	...
	//@GET
	//@Path("/{nhId}/member")
	public static ArrayList<Member> neighborhoodNhIdMemberGet(int nhId, ArrayList <ErrorRequestObject> ErrResps)
	{
        ArrayList <Member> memberList = new ArrayList<Member>();
        ErrorRequestObject erb;
        // get the connection
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdMemberGet::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return memberList;
	...
	//@GET
    //@Path("/{nhId}")
	public static ArrayList<Neighborhood> neighborhoodNhIdGet(int nhId, ArrayList <ErrorRequestObject> ErrResps)
	{
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodNhIdGet::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return nhList;
...
//		sb.append(bnn.getNeighborhood().getName() + "|" + bnn.getNeighborhood().getId() + "|"+ parent + "|"+ level + "\n" );
    ...
    //@POST
	public static ArrayList<Neighborhood>  neighborhoodPost(String nhName, int parentNhId, boolean isSecure,  ArrayList <ErrorRequestObject> ErrResps )
	{
        ArrayList <Neighborhood> nhList = new ArrayList<Neighborhood>();
        ErrorRequestObject erb;
    	...
    	try
    	{
    		...
    		catch(BoardwalkException bwe)
    		{
    			erb = new ErrorRequestObject();
    			erb.setError("Authentication_Connection_Failure");
    			erb.setPath("NeighborhoodManagement.neighborhoodPost::getBoradwalkConnection");
    			erb.setProposedSolution("Authentication/Connection Failed. Contact Boardwalk System Administrator");
    			ErrResps.add(erb);
    		    System.out.println("Authentication/Connection Failed");
    		    return nhList;
...
/*        			Vector nh0v = BoardwalkNeighborhoodManager.getNeighborhoodTree( bwcon, parentNhId);
        			Iterator nh0i = nh0v.iterator();
    				BoardwalkNeighborhoodNode bnn = (BoardwalkNeighborhoodNode)nh0i.next();
    				int level = bnn.getNeighborhood().getLevel();
*/    				
    				level += 1;
...
//  @Path("/{nhId}/collaboration")
	public static ArrayList<Collaboration> neighborhoodNhIdCollaborationGet(Integer nhId, ArrayList<ErrorRequestObject> ErrResps) 
	{
