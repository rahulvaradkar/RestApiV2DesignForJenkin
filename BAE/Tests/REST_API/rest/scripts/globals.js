...
var UserInput = {
	...
	Member_Id_1: 1000,   	//Member ID 1 of user
	Member_Id_2: 1001,   	//Member ID 2 of user
	Invalid_MemberId: 9999,
	Negative_MemberId: -1001,
	authorization: getAuthorization("restuser1", 0, "demo"),    //user1
	authorization_1: getAuthorization("restuser2", 0, "demo2"), //user2
	invalidAuthorization: getAuthorization("restuser1", 0, "ROOT|demo|JSAddin") //invalid Authorization
};
...
var NeighborhoodInput = {
	...
	NHID_2: 3,
	NHID_2_Name: "demo2",
	NHID_3: 5,   				// should not contain any collaboration
...
var CollaborationInput = {
	Collab_Id_1: 1000,			//Collaboration is under NHID_1
	Collab_Name_1: "demo",
	Collab_Id_2: 1001,			//Collaboration is under NHID_2
	Collab_Name_2: "demo2",
