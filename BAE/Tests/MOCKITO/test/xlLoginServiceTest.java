...
public class xlLoginServiceTest
{
    ...
    public void test() throws Exception {
		...
		String buffer="2"+Seperator+ds.getUsername()+Seperator;//to check user is active or not
	 	String buffer1="1"+Seperator+ds.getUsername()+Seperator+ds.getUserPassword()+Seperator+"pavandivekar1nh"+n+"";//to create new neighborhood 
	 	String buffer2="4";//to get neighborhood count
	 	String buffer3="5"+Seperator+"j300";//to change the password
...
//		encode to Base64 string
		...
		xlLoginService servlet=new xlLoginService();
		servlet.init(sg);
