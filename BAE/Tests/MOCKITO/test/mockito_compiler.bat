...
rem %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\testNG\DataSet.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\DataSet.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\AddUserServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\AggreagationServiceServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\Bw_Get_Objects_ServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\Get_Boardwalk_Template_PropServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\http_vb_getTableInfoServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\http_vb_getTableNamesServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\httpt_vb_login_test.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\LoginSevletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlCollaborationservletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlExportChangeServiceServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlGetQueryListServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlGetQueryListServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlLinkImportServiceServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlLoginServiceTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlLogoutServiceServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\xlSqlQueryServletTest.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
 %JAVA_HOME%\bin\javac %CATALINA_HOME%\webapps\%INSTANCE_NAME%\src\test\MockitoRunner2.java -classpath %CLASSPATH% -d %TARGET_DIR% -Xlint
