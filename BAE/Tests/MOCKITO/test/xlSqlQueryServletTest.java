...
import servlets.xlSqlQuery;

public class xlSqlQueryServletTest {
	@Mock
    ...
    public void test() throws Exception {
	 	...
	 	String buffer=ds.getUserId()+Seperator+ds.getUsername()+Seperator+"test"+Seperator+"SELECT CONVERT(VARCHAR(200),CONVERT(DECIMAL(20,12),DATEADD(hh,-2,DATEADD(DAY,+2,GETDATE()))))";
...
//		encode to Base64 string
		...
		xlSqlQuery servlet=new xlSqlQuery();
		servlet.init(config);
