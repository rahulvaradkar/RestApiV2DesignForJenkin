...
(function( module, test ) {
    ...
    QUnit.test( "Creating Grid", function( assert ) {
        ...
        TestUtils.sendRequest(Globals.baseURL + "rest/grid", data, UserInput.authorization, "POST").then(function(result){
    ...
    QUnit.test("Exporting Grid with Invalid Authorization", function( assert ) {
		...
		var data = {
           ...
           TestUtils.sendRequest(Globals.baseURL + "rest/grid?gridId=" + cuboid_id, data, UserInput.invalidAuthorization, "PUT").then(function(result){
                assert.ok(result != null , "Response should not be null")
    ...
    QUnit.test("Missing Cell element while Exporting Grid", function( assert ) {
        ...
        TestUtils.sendRequest(Globals.baseURL + "rest/grid?gridId=" + cuboid_id_, data, UserInput.authorization, "PUT").then(function(result){
            assert.ok(result != null,"Response Should not be null");
    ...
    QUnit.test("Importing Grid with Invalid Authorization",function(assert){
        var done=assert.async();
        TestUtils.sendRequest(Globals.baseURL+"rest/grid/"+cuboid_id+"?importTid="+GridInput.importTid+"&view=LATEST&mode=1&baselineId=-1",null, UserInput.invalidAuthorization, "GET").then(function(result){               
            assert.ok(result != null, "Response should not be null");
            assert.equal(result[0].error, "Invalid Authorization. User is not a member of Neighborhood Path.","Invalid Authorization. User is not a member of Neighborhood Path.");
            done();
        });
    ...
    QUnit.test("Importing Grid with Missing Authorization",function(assert){
        var done=assert.async();
        TestUtils.sendRequestMissingAuthorization(Globals.baseURL+"rest/grid/"+cuboid_id+"?importTid="+GridInput.importTid+"&view=LATEST&mode=1&baselineId=-1", null, "GET").then(function(result){               
            assert.ok(result != null, "Response should not be null");
            assert.equal(result[0].error, "Missing Authorization in Header","Missing Authorization in Header");
            done();
        });
    ...
    QUnit.test("Importing Grid with ImportTid is Missing",function(assert){
        var done=assert.async();
        TestUtils.sendRequest(Globals.baseURL+"rest/grid/"+cuboid_id+"?view=LATEST&mode=1&baselineId=-1",null, UserInput.authorization, "GET").then(function(result){
            assert.ok(result != null, "Response should not be null");
    ...
    QUnit.test("Importing Grid with Wrong username and wrong Password",function(assert){
        var done=assert.async();
        TestUtils.sendRequest(Globals.baseURL+"rest/grid/"+cuboid_id+"?importTid="+GridInput.importTid+"&view=LATEST&mode=1&baselineId=-1",null, getAuthorization("nhj",8,"JSAddin"), "GET").then(function(result){
            assert.ok(result != null, "Response should not be null");
    ...
    QUnit.test("Importing Grid with Wrong authorization format",function(assert){
        var done=assert.async();
        TestUtils.sendRequest(Globals.baseURL+"rest/grid/"+cuboid_id+"?importTid="+GridInput.importTid+"&view=LATEST&mode=1&baselineId=-1",null, getAuthorization("j",0,""), "GET").then(function(result){
            assert.ok(result != null, "Response should not be null");
