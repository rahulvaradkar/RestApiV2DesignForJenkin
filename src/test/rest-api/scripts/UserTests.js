(function( module, test ) {
  ...
  test("Test Case For retrieving Single User given an id", function( assert ) {
  ...
  test( "Test Case For all Active Users", function( assert ) {
      var done = assert.async();
      var flag= false;
  ...
  test("Test Case For all non-active Users", function( assert ) {
    var done = assert.async();
