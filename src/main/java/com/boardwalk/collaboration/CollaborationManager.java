...
public class CollaborationManager{
	...
	throws SystemException {
        ...
        try {
            ...
            preparedstatement = DatabaseLoader.getPreparedStatementFromPreLoadedQueries("BW_GET_COLLABS_FOR_NH", connection );
									...
									throws SystemException
    {
        ...
        try
        {
			...
			{
				System.out.println("Oracle version of getActivitySummary() not implemented");
			}
			else
			{
    ...
    public static Collaboration getCollaborationInfo( Connection connection, int a_user_id, int a_collaboration_id ) throws SystemException {
        ...
        try {
            ...
            if ( DatabaseLoader.getDatabaseType().trim().equalsIgnoreCase("ORACLE"))
				{
					preparedstatement = DatabaseLoader.getPreparedStatementFromPreLoadedQueries("BW_GET_COLLAB_INFO_FOR_USER", connection );
					preparedstatement.setInt(1,a_user_id);
					preparedstatement.setInt(2,a_collaboration_id);
