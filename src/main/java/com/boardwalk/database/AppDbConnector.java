...
public class AppDbConnector
{
	...
	public static String msInstanceName = "";//Changed by Santosh(Yoddha) to accept Instance Name
	...
	public static BoardwalkConnection getConnection(String asMemberId) throws SQLException
	{
        ...
        //String jdbcConnectionString = "jdbc:microsoft:sqlserver://"+msDBServer+":"+msDBServerPort+";DatabaseName="+msDBName+";user="+msDBUser+";password="+msDBPassword+";SelectMethod=direct";
		  String jdbcConnectionString = "jdbc:jtds:sqlserver://"+msDBServer+":"+msDBServerPort+";instance="+msInstanceName+";DatabaseName="+msDBName+";sendStringParametersAsUnicode=true"+ ";user="+msDBUser+";password="+msDBPassword; //Changed by Santosh(Yoddha) to accept Instance Name 
	  	try
        {
