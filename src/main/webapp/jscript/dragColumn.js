...
function onMouseDown()
{
	...
	headRow = src
	// get the head row from the th
	while (headRow.tagName != "TR") 
		headRow = headRow.parentElement;
...
function onMouseMove()
{
	...
	objDragItem.style.pixelTop  = intTop - cx;
	objDragItem.style.pixelLeft = intLeft - cy;
